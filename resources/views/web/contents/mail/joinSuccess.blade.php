...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="margin: 0; padding: 0; font-size: 62.5%;">
		<table border="0" cellspacing="0" cellpadding="0" style="background-image: url(http://dev-www.beanpop.cn/img/mail/background.png); background-size: 100% 100%; width: 100%; text-align: center; font-size: 1.4rem; font-weight: bold;">
			...
			<tr>
				<td style="padding-top: 1rem; padding-left: 20px; padding-right: 20px;">兹授权<span style="margin-left: 1rem; margin-right: 1rem;">王康辉</span>为深圳喜豆文化发展有限公司<span style="margin-left: 1rem; margin-right: 1rem;">广东省深圳市南山区</span>销售合伙人，</td>
			</tr>
			<tr>
				<td style="padding-top: 1rem; padding-left: 20px; padding-right: 20px;">获得我司在该授权区域所有产品的销售权限。</td>
			</tr>
			<tr>
				<td style="padding-top: 2rem; padding-left: 20px; padding-right: 20px;">
                    授权期限为两年&nbsp;<span >2018</span>&nbsp;年&nbsp;<span >7</span>&nbsp;月&nbsp;<span>1</span>&nbsp;日至&nbsp;<span >2019</span>&nbsp;年&nbsp;<span >7</span>&nbsp;月&nbsp;<span >1</span>&nbsp;日为止。
				</td>
			</tr>
			<tr>
				<td  style="padding-top: 1rem; padding-left: 20px; padding-right: 20px; font-weight: 500; font-size: 1rem;">备注：本授权书以正本为有效文本，不得影印，涂改，转让</td>
			</tr>
			<tr>
